...
# Add a feature for counting passager's family member size
...
fig.suptitle("Confusion Matrix of different model", fontsize = 16)
...
#  4. KNeighborsClassifier                        0.78212
# -------------------------------------------------------
#                 precision    recall  f1-score   support
...
#  5. DecisionTreeClassifier                      0.77095
# -------------------------------------------------------
#                 precision    recall  f1-score   support

#            0       0.76      0.91      0.82       106
#            1       0.81      0.58      0.67        73
